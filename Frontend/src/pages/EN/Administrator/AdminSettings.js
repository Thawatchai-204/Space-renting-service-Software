...
import './AdminSettings.css'; // สร้างไฟล์ CSS สำหรับหน้า Settings
                ...
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="navbarNav">
                        ...
                        <div className="d-flex align-items-center gap-3">
                            <a href="/AdminProfile" className="text-decoration-none text-light">{username || 'User'}</a> {/* แสดงชื่อผู้ใช้ */}
                            <a href="/AdminWallet" className="btn btn-outline-light btn-sm"><FaBell className="me-2" /> {language === 'EN' ? 'Wallet' : 'กระเป๋าเงิน'}: {walletBalance} THB</a> {/* แสดงยอดเงินใน Wallet */}

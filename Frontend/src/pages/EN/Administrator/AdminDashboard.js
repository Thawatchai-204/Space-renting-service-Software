        ...
        <div className="container-fluid">
                ...
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="navbarNav">
                        ...
                        <div className="d-flex align-items-center gap-3">
                            ...
                            <a href="/AdminWallet" className="btn btn-outline-light btn-sm"><FaBell className="me-2" /> {language === 'EN' ? 'Wallet' : 'กระเป๋าเงิน'}: {walletBalance} THB</a>
            ...
            <div className="header-image position-relative">
                ...
                <div className="header-content position-absolute top-50 start-50 translate-middle text-center text-white">
                    <h1 className="fw-bold">{language === 'EN' ? 'come to Our WelSpace Rental Service provider' : 'ยินดีต้อนรับสู่บริการเช่าพื้นที่'}</h1>
            ...
            <main className="container-fluid mt-5 pt-4">
                <header className="d-flex justify-content-between align-items-center mb-4">
                    <h1 className="fw-bold">{language === 'EN' ? 'Wellcome Admin' : 'ยินดีต้อนรับผู้ดูแลระบบ'}</h1>
                </header>
